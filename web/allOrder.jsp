...
<div id="content">
    <div id="content-left">
        ...
        <h3>My order</h3>
        <ul>
            <a href="<c:url value="/allOrder.jsp"/>"><li id="highlight">All orders</li></a>
            ...
            <div id="profile-content-order">
                <c:forEach items="${orders}" var="orders">
                    <div>
                        ...
                        <c:if test="${orders.shippedDate eq null}">
                            <a href="<c:url value="/cancelOrder"></c:url>?&id=${orders.orderID}" class="cancel-order" >Cancel Order</a> 
                            </c:if>
                    </div>
                </c:forEach>
